...
public class CustomerGUI {
	...
	private static ArrayList<String> getSelectedCellValues() { // Col: 0 = First name, 1 = Last name, 2 = House number, 3 = Address, 4 = City, 5 = Postcode, 6 = Phone number.
		...
		int row = customersTable.getSelectedRow();
		String firstName = customersTable.getModel().getValueAt(row, 1).toString();
		String lastName = customersTable.getModel().getValueAt(row, 2).toString();
		String houseNumber = customersTable.getModel().getValueAt(row, 3).toString();
		String address = customersTable.getModel().getValueAt(row, 4).toString();
		String city = customersTable.getModel().getValueAt(row, 5).toString();
		String postcode = customersTable.getModel().getValueAt(row, 6).toString();
		String phoneNumber = customersTable.getModel().getValueAt(row, 7).toString();
